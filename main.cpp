...
void enterToContinue(bool prevInput) {
    #define CONT_REMINDER "\n(Enter to continue)"
    cout << CONT_REMINDER;
    cin.clear();
    if (prevInput) cin.ignore(numeric_limits<streamsize>::max(), '\n');
    cin.get();
    CLEAR_CONSOLE;
}
